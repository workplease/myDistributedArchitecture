...
public class NettyChannelPoolFactory {
    ...
    private static final Map<InetSocketAddress, ArrayBlockingQueue<Channel>>
            channelPoolMap = Maps.newConcurrentMap();
    ...
    public Channel registerChannel(InetSocketAddress socketAddress) {
        try {
            ...
            final Channel newChannel = (Channel) channelFuture.channel();
