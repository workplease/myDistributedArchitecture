...
import zzz.ares.remoting.framework.provider.ProviderFactoryBean;

/**
 * @Author: milkteazzz
 * @Data: 2020-12-06 1:33
 * @Version: 1.0
 *
 * 解析服务发布自定义标签
 */
public class ProviderFactoryBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
    ...
    //logger
    Logger logger = LoggerFactory.getLogger(ProviderFactoryBeanDefinitionParser.class);
    ...
    protected void doParse(Element element, BeanDefinitionBuilder bean) {
        try{
            ...
            bean.addPropertyValue("serviceObject",ref);
